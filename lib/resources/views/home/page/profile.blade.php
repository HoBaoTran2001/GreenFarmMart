                ...
                <div class="row">
                    <div class="col-sm-4">
                        ...
                        <ul class="list-group">
                            ...
                            <li class="list-group-item text-right"><span class="pull-left"><strong>Lượt mua hàng</strong></span> 13</li>
                            <li class="list-group-item text-right"><span class="pull-left"><strong>Điểm tích lũy</strong></span> 37</li>
                            <li class="list-group-item text-right"><span class="pull-left"><strong>Cáp bậc</strong></span>Cấp bậc vàng</li>
                        </ul>
                    </div>    
                    <div class="col-sm-8 tab-pane active" id="home">
                        ...
                        <div class="form-group">
                            <div class="col-xs-6">
                                ...
                                <input type="text" class="form-control input-text" name="email"   value="{{$user->email}}">
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-xs-6">
