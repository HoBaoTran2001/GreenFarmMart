                        ...
                        <tr style="border:1px solid green;">
                            ...
                            <td style="text-align: right;" colspan="5">
                                @if ($coupon_condition == 1)
                                    ...
                                    Số tiền thu hộ thanh toán: {{number_format((($total * $coupon_value)/100) + $fee_ship)}} VNĐ
                                @elseif ($coupon_condition == 2)
                                    Số tiền đơn hàng: {{number_format($total - $coupon_value)}} VNĐ<br>
                                    Phí vận chuyển: {{number_format($fee_ship)}} VNĐ<br>
                                    Số tiền thu hộ thanh toán: {{number_format(($total - $coupon_value) + $fee_ship)}} VNĐ
                                ...
                                @else
                                    Số tiền đơn hàng: {{number_format($total)}} VNĐ<br>
                                    Phí vận chuyển: {{number_format($fee_ship)}} VNĐ<br>
                                    Số tiền thu hộ thanh toán: {{number_format($total + $fee_ship)}} VNĐ
                                @endif
                            </td>
                        </tr>
