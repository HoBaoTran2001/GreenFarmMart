                                        ...
                                        <tr>
                                            <td colspan="8" style="font-weight: bold">
                                                @if ($coupon_condition == 1)
                                                    ...
                                                    Tổng hóa đơn: {{number_format((($total * $coupon_value)/100) + $row->product_feeship)}}đ
                                                @elseif ($coupon_condition == 2)
                                                    Hóa đơn ban đầu: {{number_format($total)}}đ<br>
                                                    Phí vận chuyển: {{number_format($row->product_feeship)}}đ<br>
                                                    Số tiền sau giảm giá: {{number_format($total - $coupon_value)}}đ <br>
                                                    Tổng hóa đơn: {{number_format(($total - $coupon_value) + $row->product_feeship)}}đ 
                                                @else
                                                    Hóa đơn ban đầu: {{number_format($total)}}đ<br>
                                                    Phí vận chuyển: {{number_format($row->product_feeship)}}đ<br>
                                                    Tổng hóa đơn: {{number_format($total + $row->product_feeship)}}đ
                                                @endif
                                            </td>
                                        </tr>
                                        <tr>
